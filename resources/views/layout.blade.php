...
<html lang="en">
    <head>
        ...
        <link href="{{asset('admin/css/docs.min.css')}}" rel="stylesheet">

        <script src="{{asset('admin/js/jquery.min.js')}}"></script>

        <script type="text/javascript" src="{{asset('admin/js/shCore.js')}}"></script>
        <script type="text/javascript" src="{{asset('admin/js/shBrushXml.js')}}"></script>
        <link type="text/css" rel="stylesheet" href="{{asset('admin/css/shCoreDefault.css')}}"/>
                ...
                <div class="col-md-12">
                    ...
                    <div id="files_and_directories">
                        <div class="content">
                            ...
                            <div class="col-md-6">
                                <img src="{{asset('images/welcome.png')}}" style="width: 100%; border: 1px solid #ccc; padding:5px;" />
                            </div>
